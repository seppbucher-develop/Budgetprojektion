import { getState, updateState } from "./store.js?v=24";
import { berechneProjektion } from "./projection.js?v=24";
import { drawLineChart, currencyFormatter } from "./charts.js?v=24";
