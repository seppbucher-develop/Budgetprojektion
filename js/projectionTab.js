import { getState, updateState } from "./store.js?v=22";
import { berechneProjektion } from "./projection.js?v=22";
import { drawLineChart, currencyFormatter } from "./charts.js?v=22";
