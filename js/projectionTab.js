import { getState, updateState } from "./store.js?v=12";
import { berechneProjektion } from "./projection.js?v=12";
import { drawLineChart, currencyFormatter } from "./charts.js?v=12";
