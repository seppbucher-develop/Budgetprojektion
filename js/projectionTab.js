import { getState, updateState } from "./store.js?v=23";
import { berechneProjektion } from "./projection.js?v=23";
import { drawLineChart, currencyFormatter } from "./charts.js?v=23";
