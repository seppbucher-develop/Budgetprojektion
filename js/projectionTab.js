import { getState, updateState } from "./store.js?v=16";
import { berechneProjektion } from "./projection.js?v=16";
import { drawLineChart, currencyFormatter } from "./charts.js?v=16";
