import { getState, updateState } from "./store.js?v=15";
import { berechneProjektion } from "./projection.js?v=15";
import { drawLineChart, currencyFormatter } from "./charts.js?v=15";
