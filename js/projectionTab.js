import { getState, updateState } from "./store.js?v=20";
import { berechneProjektion } from "./projection.js?v=20";
import { drawLineChart, currencyFormatter } from "./charts.js?v=20";
