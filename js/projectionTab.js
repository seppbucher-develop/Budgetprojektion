import { getState, updateState } from "./store.js?v=21";
import { berechneProjektion } from "./projection.js?v=21";
import { drawLineChart, currencyFormatter } from "./charts.js?v=21";
