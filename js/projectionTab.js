import { getState, updateState } from "./store.js?v=8";
import { berechneProjektion } from "./projection.js?v=8";
import { drawLineChart, currencyFormatter } from "./charts.js?v=8";
