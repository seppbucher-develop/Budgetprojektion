import { getState, updateState } from "./store.js?v=6";
import { berechneProjektion } from "./projection.js?v=6";
import { drawLineChart, currencyFormatter } from "./charts.js?v=6";
