import { getState, updateState } from "./store.js?v=13";
import { berechneProjektion } from "./projection.js?v=13";
import { drawLineChart, currencyFormatter } from "./charts.js?v=13";
