import { getState, updateState } from "./store.js?v=3";
import { berechneProjektion } from "./projection.js?v=3";
import { drawLineChart, currencyFormatter } from "./charts.js?v=3";
