import { getState, updateState } from "./store.js?v=10";
import { berechneProjektion } from "./projection.js?v=10";
import { drawLineChart, currencyFormatter } from "./charts.js?v=10";
