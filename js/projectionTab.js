import { getState, updateState } from "./store.js?v=17";
import { berechneProjektion } from "./projection.js?v=17";
import { drawLineChart, currencyFormatter } from "./charts.js?v=17";
