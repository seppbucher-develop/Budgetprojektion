...
import { buchungenFuerJahrKategorie } from "./compare.js?v=7";
import { betragFormatter } from "./charts.js?v=7";
import { formatIsoDate } from "./dateUtils.js?v=7";
import { kategorieName, unterkategorieName } from "./kategorien.js?v=7";
